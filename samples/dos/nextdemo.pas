...
begin
	...
	writeln (' Free space in drive ', Character, ': ', 
				(GetDriveSpaceInfo (Character, true)/1024):0:0 , ' Mb.');
...
begin
	...
	begin
		...
		writeln (' Start sector: ', 	((65536 - StartSectorMinor) + 
										(65536 * StartSectorMajor)));
		writeln ( ' Partition size: ', ((65536 - PartitionSizeMinor) + 
										(65536 * PartitionSizeMajor)));
	end;
